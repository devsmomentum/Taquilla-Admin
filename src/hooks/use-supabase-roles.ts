      ...
      const defaultRoles: Role[] = [
        {
          ...
          permissions: ['dashboard', 'reports', 'lotteries', 'bets', 'winners', 'history', 'users', 'roles', 'api-keys', 'comercializadoras', 'porcentajes'],
        ...
        },
        {
          ...
          description: 'Gestiona agencias y taquillas de su comercializadora',
          permissions: ['dashboard', 'comercializadoras'],
          createdAt: new Date().toISOString(),
          isSystem: true,
        },
        {
